...
try{
	...
	if(tempStr!=null && !tempStr.equals(""))
	 ...
	 if(rs.next())
	  ...
	  p=(currentPage-1)*e;
	  String sql ="select amount,asktime,name,cycle,rate,reason,id from loan where dealTime = '0000-00-00 00:00:00' order by amount limit "+p+","+e;
	  prepStmt = con.prepareStatement(sql);
	      //prepStmt.setString(1, yourname);
	      rs = prepStmt.executeQuery();
  %>
<font size="5">
<h1></ht><a href="form3.jsp" >按周期排序 </a>&nbsp;按金额排序</h1>
